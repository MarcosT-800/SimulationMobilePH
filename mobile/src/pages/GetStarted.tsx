...
const handleLogin = async () => {
    try {
      const data = await login(user_login, user_pass);
  ...
  return (
    <div className="body">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="56" height="8" viewBox="0 0 56 8" fill="none">
        ...
        <circle cx="20" cy="4" r="4" fill="white" fill-opacity="0.25" />
        <circle cx="36" cy="4" r="4" fill="white" fill-opacity="0.25" />
      ...
      <IonModal ref={modal} trigger="open-modal" initialBreakpoint={1} breakpoints={[0, 1]} >
        <div className="block">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="75" height="2" viewBox="0 0 75 2" fill="none">
           <path d="M1 1H74" stroke="#F6F6F6" stroke-width="1.5" stroke-linecap="round"/>
          </svg>
            <p className="custom-p-hr">Suporte para login</p>
            <svg xmlns="http://www.w3.org/2000/svg" width="75" height="2" viewBox="0 0 75 2" fill="none">
                <path d="M1 1H74" stroke="#F6F6F6" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          </div>
